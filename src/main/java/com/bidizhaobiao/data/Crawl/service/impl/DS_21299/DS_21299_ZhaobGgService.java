package com.bidizhaobiao.data.Crawl.service.impl.DS_21299;
 ...
 * 原网站：https://wiat.ac.cn/xxgg
 * 主页：https://wiat.ac.cn
 **/
@Service
public class DS_21299_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://wiat.ac.cn/xxgg?pageIndex=1";
    public String baseUrl = "https://wiat.ac.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "21299";
    // 网站名称
    public String sourceName = "武汉中科先进技术研究院有限公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("pageIndex")) {
                ...
                Elements listElement = doc.select("div.innerDynamic>dl:has(a)");
                if (listElement.size() > 0) {
                    ...
                    for (Element element : listElement) {
                        ...
                        if (title.length() < 2) title = element.select("h3").text().trim();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.content-list").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select("div.content-title>h3").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        Matcher dateMat = datePat.matcher(doc.select("div.content-title>p").text());
                        if (dateMat.find()) {
