 ...
 **/
@Service
public class DS_16506_1_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.htyngs.cn/zhaobiao/?type=list&classid=9";
    public String baseUrl = "http://www.htyngs.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");
    // 网站编号
    public String sourceNum = "16506-1";
    // 网站名称
