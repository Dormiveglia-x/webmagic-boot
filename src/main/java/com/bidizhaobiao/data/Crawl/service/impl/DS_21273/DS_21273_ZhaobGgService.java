package com.bidizhaobiao.data.Crawl.service.impl.DS_21273;
...
/**
 * 程序员：周素茵 日期：2022-04-13
 * 原网站：http://pe.peszjrmfy.gov.cn/article/index/id/M0zLNzBIMjAwNSACAAA.shtml
 * 主页：http://pe.peszjrmfy.gov.cn
 **/
@Service
public class DS_21273_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://pe.peszjrmfy.gov.cn/article/index/id/M0zLNzBIMjAwNSACAAA/page/1.shtml";
    public String baseUrl = "http://pe.peszjrmfy.gov.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");
    String key = "竞争、询标、交易、机构、需求、废旧、废置、处置、报废、供应商、承销商、服务商、调研、优选、择选、择优、选取、公选、选定、摇选、摇号、摇珠、抽选、定选、定点、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、标段、明标、明投、出让、转让、拍卖、招租、出租、预审、发包、承包、分包、外包、开标、遴选、答疑、补遗、澄清、延期、挂牌、变更、预公告、监理、改造工程、报价、小额、零星、自采、商谈";
    String[] keys = key.split("、");
    // 网站编号
    public String sourceNum = "21273";
    // 网站名称
    public String sourceName = "云南省普洱市中级人民法院";
    // 信息源
    ...
    //附件未下载是否备注内容巡检
    public boolean isSkipFileError = true;

    public Site getSite() {
        return this.site.setUserAgent("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.75 Safari/537.36");
    }
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("page")) {
                ...
                Elements listElement = doc.select("div#main div.list_br>ul>li:has(a)");
                ...
                Element nextPage = doc.select("a:contains(下一页)").last();
                ...
                if (branch != null) {
                    ...
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select("div.b_title").first();
                        if (titleElement != null) {
                            titleElement.select("br").remove();
