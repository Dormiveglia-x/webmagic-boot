package com.bidizhaobiao.data.Crawl.service.impl.DX011876;
 ...
 * 原网站：http://www.gxgczxjt.com/c/industry.html
 * 主页：http://www.gxgczxjt.com
 **/
@Service
public class DX011876_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.gxgczxjt.com/c/industry.html";
    public String baseUrl = "http://www.gxgczxjt.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX011876";
    // 网站名称
    public String sourceName = "广西工程咨询集团有限公司";
    // 信息源
    ...
    // 设置城市
    public String city = "南宁";
    // 设置县
    public String district = "青秀";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("industry")) {
                ...
                Elements listElement = doc.select("div.julous>a");
                if (listElement.size() > 0) {
                    for (Element a : listElement) {
                        ...
                        String date = "";
                        Matcher dateMat = datePat.matcher(a.select("p").text());
                        if (dateMat.find()) {
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.show").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select(".show_titles h1").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select(".show_titles p").remove();
