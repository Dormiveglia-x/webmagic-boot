 ...
 * 原网站：http://ggzyjy.weihai.cn/rushan/jyxx/003004/003004003/transInfo.html
 * 主页：http://ggzyjy.weihai.cn
 **/

@Service("QX_03870_17_ChanqJyService")
public class QX_03870_17_ChanqJyService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "03870-17";
    // 网站名称
            ...
            if (url.equals("http://ggzyjy.weihai.cn/EpointWebBuilder/rest/getOauthInfoAction/getNoUserAccessToken")) {
                ...
                if (custom.has("count")) {
                    ...
                    if (arr.length() > 0) {
                        ...
                        if (custom.getInt("count") != 0) dealWithNullListPage(serviceContext);
                    }
                } else {
...
//                    serviceContext.setPageNum(serviceContext.getPageNum() + 1);
    ...
    public Request getListRequest(int pageNo) {
        ...
        try {
            ...
            params.put("params", "{\"siteGuid\":\"caf3f935-94d7-4d37-b361-16db510865c3\",\"categoryNum\":\"003004003\",\"kw\":\"\",\"startDate\":\"\",\"endDate\":\"\",\"pageIndex\":" + pageNo + ",\"pageSize\":12,\"area\":\"\"}");
