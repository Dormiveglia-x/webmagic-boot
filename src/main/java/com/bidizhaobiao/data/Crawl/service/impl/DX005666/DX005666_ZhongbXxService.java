package com.bidizhaobiao.data.Crawl.service.impl.DX005666;
 ...
 * 程序员：郑坚荣
 * 日期：2020-01-02
 * 原网站：http://www.hxsyjt.net/zhaobiao/zbgg/index.html
 * 主页：http://www.hxsyjt.net/
 **/
@Service
public class DX005666_ZhongbXxService extends SpiderService implements PageProcessor {
    public  Spider spider = null;

    public  String listUrl = "http://www.hxsyjt.net/zhaobiao/zbgg/index.html";
    public  String baseUrl = "http://www.hxsyjt.net";
    // 抓取网站的相关配置，包括：编码、抓取间隔、重试次数等
    Site site = Site.me().setCycleRetryTimes(2).setTimeOut(30000).setSleepTime(20);

    // 网站编号
    public String sourceNum = "DX005666";
    // 网站名称
    public String sourceName = "红星实业集团";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/index")) {
                ...
                Element conTag = doc.select("div[class=zb_zblb] ul").first();
                ...
                if (ele != null && ele.attr("href").startsWith("/zhaobiao") && serviceContext.isNeedCrawl()) {
                ...
                if (bn != null) {
                    ...
                    Element div = doc.select("div[class=w_gs_xq]").first();
                    if (div != null) {
                        Element titleText = div.select("h2").first();
                        if (titleText != null) {
