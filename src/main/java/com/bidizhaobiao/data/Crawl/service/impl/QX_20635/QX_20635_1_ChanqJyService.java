package com.bidizhaobiao.data.Crawl.service.impl.QX_20635;
 ...
 * 原网站：https://chenghai.nongjiao.com/node/98853/landDataMore/1
 * 主页：https://chenghai.nongjiao.com
 **/
@Service
public class QX_20635_1_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://chenghai.nongjiao.com/node/98853/landDataMore/1";
    public String baseUrl = "https://chenghai.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20635-1";
    // 网站名称
    public String sourceName = "澄海区农村产权交易所";
    // 信息源
