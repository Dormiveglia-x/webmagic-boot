 ...
 * 程序员：郭建婷
 * 日期：2022-02-15
 * 原网站：http://www.xmta.gov.cn/zc/zdly/gcztb/jggs/
 * 主页：http://www.xmta.gov.cn
 **/
@Service("QX_01516_2_ZhongbXxService")
public class QX_01516_2_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.xmta.gov.cn/zc/zdly/gcztb/jggs/index.htm";
            ...
            if (url.contains("/index")) {
                ...
                if (lists.size() > 0) {
                    for (Element list : lists) {
                        ...
                        String id = "/zc/zdly/gcztb/jggs/" + list.select("a").attr("href").replaceAll("\\./", "");
