package com.bidizhaobiao.data.Crawl.service.impl.QX_20648;
 ...
 * 原网站：https://longyou.nongjiao.com/node/58668/landDataMore/1
 * 主页：https://longyou.nongjiao.com
 **/
@Service
public class QX_20648_1_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://longyou.nongjiao.com/node/58668/landDataMore/1";
    public String baseUrl = "https://longyou.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20648-1";
    // 网站名称
    public String sourceName = "龙游县农村产权交易所";
    // 信息源
    ...
    // 设置城市
    public String city = "衢州市";
    // 设置县
    public String district = "龙游县";
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                Elements list = document.select(".tl_listing");
                ...
                //下一页
                if (list.size() >= 12 && serviceContext.isNeedCrawl()) {
                    serviceContext.setPageNum(serviceContext.getPageNum() + 1);
                    int nextPage = serviceContext.getPageNum();
                    page.addTargetRequest(listUrl.replace("landDataMore/1","landDataMore/"+nextPage));
                }
                ...
                if (bn != null) {
                    ...
                    Element basecontent = doc.select(".transaction_details-main-box").first();
                    if (basecontent != null) {
