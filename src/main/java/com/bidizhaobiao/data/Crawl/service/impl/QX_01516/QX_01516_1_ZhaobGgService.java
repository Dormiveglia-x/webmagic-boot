...
/**
 * 程序员：周素茵 日期：2022-12-30

 * 原网站：http://www.xmta.gov.cn/zc/zdly/zfcg/cgtz/
 * 主页：http://www.xmta.gov.cn
 **/
@Service("QX_01516_1_ZhaobGgService")
public class QX_01516_1_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    public String listUrl = "http://www.xmta.gov.cn/zc/zdly/zfcg/cgtz/index.htm";
    ...
    // 网站编号
    public String sourceNum = "01516-1";
    // 网站名称
            ...
            if (url.contains("/index")) {
                ...
                if (lists.size() > 0) {
                    for (Element list : lists) {
                        ...
                        String href = list.select("a").attr("href").replaceAll("\\./", "");
                        if (href.startsWith("http") && !href.contains(baseUrl.replaceAll("http|https", ""))) {
                            continue;
                        }
                        String id = "/zc/zdly/zfcg/cgtz/" + href;
