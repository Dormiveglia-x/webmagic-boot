...
@Service("QX_02669_1_ZhaobGgService")
public class QX_02669_1_ZhaobGgService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://bm.zhangpu-ks.cn/gslist.aspx?key=%E6%8B%9B%E6%A0%87%E5%85%AC%E5%91%8A";
    ...
    // 网站编号
    public String sourceNum = "02669-1";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("key")) {
                ...
                Elements lis = document.select("ul#ul_xmgg li:has(a)");
                if (lis.size() > 0) {
                    for (Element li : lis) {
