...
@Service("QX_02669_5_ZhongbXxService")
public class QX_02669_5_ZhongbXxService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://bm.zhangpu-ks.cn/dlcglist.aspx?type=%E4%B8%AD%E6%A0%87%E5%85%AC%E7%A4%BA";
    ...
    // 网站编号
    public String sourceNum = "02669-5";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("type")) {
                ...
                Elements lis = document.select("ul#ul_zbgs li:has(a)");
                if (lis.size() > 0) {
                    for (Element li : lis) {
