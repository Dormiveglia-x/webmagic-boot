 ...
 * 原网站：http://www.ycgntz.com/news/1151.html
 * 主页：http://www.ycgntz.com/
 **/
@Service
public class DX011433_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    public String listUrl = "http://www.ycgntz.com/news/1151-1.html";
    public String baseUrl = "http://www.ycgntz.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");
    // 网站编号
    public String sourceNum = "DX011433";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                if (listElement.size() >= 6 && serviceContext.isNeedCrawl()) {
                    serviceContext.setPageNum(serviceContext.getPageNum() + 1);
                    page.addTargetRequest(listUrl.replace("1151-1", "1151-" + serviceContext.getPageNum()));
                }
            } else {
