 ...
 * 程序员：杨业深
 * 日期：2022-02-09
 * 原网站：http://rs.whggzyjy.cn/jyxxcgxq/index.jhtml
 * 主页：http://ggzyjy.weihai.cn
 **/
@Service
public class QX_03870_3_ZhaobGgService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "03870-3";
    // 网站名称
    ...
    public Request getListRequest(int pageNo) {
        ...
        try {
            ...
            params.put("params", "{\"siteGuid\":\"caf3f935-94d7-4d37-b361-16db510865c3\",\"categoryNum\":\"003002001\",\"kw\":\"\",\"startDate\":\"\",\"endDate\":\"\",\"pageIndex\":" + pageNo + ",\"pageSize\":12,\"area\":\"\"}");
