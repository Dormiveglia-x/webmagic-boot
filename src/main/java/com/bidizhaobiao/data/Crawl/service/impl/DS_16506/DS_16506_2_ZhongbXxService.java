package com.bidizhaobiao.data.Crawl.service.impl.DS_16506;
...
/**
 * 程序员：邓敏 日期：2022-02-15
 * 原网站：http://www.htyngs.cn/zhaobiao/
 * 主页：http://www.htyngs.cn
 **/
@Service
public class DS_16506_2_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.htyngs.cn/zhaobiao/?type=list&classid=11";
    public String baseUrl = "http://www.htyngs.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");
    // 网站编号
    public String sourceNum = "16506-2";
    // 网站名称
    public String sourceName = "山东菏投一诺全程管理咨询有限公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                Elements listElement = doc.select("ul.dang_list li");
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        Element a = element.select("a").first();
                        String link = a.attr("href").trim();
                        String id = link.substring(link.lastIndexOf("=") + 1);
                        link = baseUrl + "/zhaobiao/" + link;
...
//                }
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.all_right").first();
                    ...
                    if (contentElement != null) {
                        ...
                        Element titleElement = contentElement.select("div.all_right_title").first();
                        if (titleElement != null) {
                            title = titleElement.text().trim();
                        }
                        contentElement.select("p.all_right_say").remove();
                        contentElement.select("div.pageinfo").remove();
