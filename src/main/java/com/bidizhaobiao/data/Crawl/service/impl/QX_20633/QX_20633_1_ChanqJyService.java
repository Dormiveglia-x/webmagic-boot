package com.bidizhaobiao.data.Crawl.service.impl.QX_20633;
 ...
 * 原网站：https://haojiang.nongjiao.com/node/98712/landDataMore/1
 * 主页：https://haojiang.nongjiao.com
 **/
@Service
public class QX_20633_1_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://haojiang.nongjiao.com/node/98712/landDataMore/1?";
    public String baseUrl = "https://haojiang.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20633-1";
    // 网站名称
    public String sourceName = "濠江区农村产权交易所";
    // 信息源
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                if (list.size() >= 12 && serviceContext.isNeedCrawl()) {
                    ...
                    String nextUrl = "https://haojiang.nongjiao.com/node/98712/landDataMore/"+nextPage+"?";
