 ...
 * 原网站：http://ggzyjy.weihai.cn/rushan/jyxx/003001/003001007/transInfo.html
 * 主页：http://rs.whggzyjy.cn/
 **/

@Service
public class QX_03870_5_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;
    public String listUrl = "http://ggzyjy.weihai.cn/EpointWebBuilder/rest/frontAppCustomAction/getPageInfoListNew";
    public String baseUrl = "http://rs.whggzyjy.cn";
    public Map<String, BranchNew> map = new HashMap<>();
    // 网站编号
    public String sourceNum = "03870-5";
    // 网站名称
    ...
    public Request getListRequest(int pageNo) {
        ...
        try {
            ...
            params.put("params", "{\"siteGuid\":\"caf3f935-94d7-4d37-b361-16db510865c3\",\"categoryNum\":\"003001007\",\"kw\":\"\",\"startDate\":\"\",\"endDate\":\"\",\"pageIndex\":" + pageNo + ",\"pageSize\":12,\"area\":\"\"}");
