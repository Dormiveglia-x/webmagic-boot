package com.bidizhaobiao.data.Crawl.service.impl.QX_20630
        ;
...
/**
 * @程序员: 唐家逸 日期：2022-02-15 13:38
 * @原网站: https://chaonan.nongjiao.com/node/98806/landDataMore/1
 * @主页：TODO
 **/
@Service("QX_20630_2_ChanqJyService")
public class QX_20630_2_ChanqJyService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "https://chaonan.nongjiao.com/node/98805/landSearchMore/1";

    public String baseUrl = "https://chaonan.nongjiao.com";
    // 网站编号
    public String sourceNum = "20630-2";
    // 网站名称
    public String sourceName = "潮南区农村产权交易所";
    // 信息源
