...
@Service("QX_02669_3_ZhaobGgService")
public class QX_02669_3_ZhaobGgService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://bm.zhangpu-ks.cn/dlcglist.aspx?key=%E9%87%87%E8%B4%AD%E5%85%AC%E5%91%8A&type=%E4%BB%A3%E7%90%86%E9%87%87%E8%B4%AD";
    ...
    // 网站编号
    public String sourceNum = "02669-3";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("key")) {
                ...
                Elements lis = document.select("ul#ul_zfcggg li:has(a)");
                if (lis.size() > 0) {
                    for (Element li : lis) {
