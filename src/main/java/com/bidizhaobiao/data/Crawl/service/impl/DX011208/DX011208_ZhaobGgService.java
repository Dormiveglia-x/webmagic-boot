package com.bidizhaobiao.data.Crawl.service.impl.DX011208;
 ...
 * 原网站：http://www.ahxlxmy.com/gz111/vip_doc/15654985_1493365_0_1.html
 * 主页：http://www.ahxlxmy.com
 **/
@Service
public class DX011208_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.ahxlxmy.com/gz111/vip_doc/15654985_1493365_0_1.html";
    public String baseUrl = "http://www.ahxlxmy.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "DX011208";
    // 网站名称
    public String sourceName = "安徽心连心米业有限公司";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            Thread.sleep(500);
            if (url.contains("_0_1.html")) {
                Document doc = Jsoup.parse(page.getRawText());
                Elements listElement = doc.select("#text_listmodule_2 li:has(a)");
                if (listElement.size() > 0) {
                    String key = "交易、机构、需求、废旧、废置、处置、报废、供应商、承销商、服务商、调研、择选、择优、选取、优选、公选、选定、摇选、摇号、摇珠、抽选、定选、定点、招标、采购、询价、询标、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、标段、明标、明投、出让、转让、拍卖、招租、出租、预审、发包、承包、分包、外包、开标、遴选、答疑、补遗、澄清、延期、挂牌、变更、预公告、监理、改造工程、报价、小额、零星、自采、商谈";
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div#Mo_657 table.MoBody td.MoBodyM").first();
                    if (contentElement != null) {
                        ...
                        contentElement.select("div#pDetailsPreNext").remove();
