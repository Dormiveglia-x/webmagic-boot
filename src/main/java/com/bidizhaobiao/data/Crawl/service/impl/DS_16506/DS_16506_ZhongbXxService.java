 ...
 **/
@Service
public class DS_16506_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.htyngs.cn/zhaobiao/?page=1";
    public String baseUrl = "http://www.htyngs.cn";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");
    // 网站编号
    public String sourceNum = "16506";
    // 网站名称
