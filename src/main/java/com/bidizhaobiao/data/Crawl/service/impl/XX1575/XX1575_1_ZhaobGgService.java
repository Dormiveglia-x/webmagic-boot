 ...
 * 原网站：http://www.zjyc.edu.cn/xwzx/tzgg.htm
 * 主页：http://www.zjyc.edu.cn
 **/

@Service
public class XX1575_1_ZhaobGgService extends SpiderService implements PageProcessor {

    public  Spider spider = null;

    public  String listUrl = "http://www.zjyc.edu.cn/xwzx/tzgg.htm";
    public  String baseUrl = "http://www.zjyc.edu.cn";
    public  Pattern dateRex = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "XX1575-1";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("/tzgg")) {
                Elements listElement = doc.select("div.list_con li:has(a)");
                if (listElement.size() > 0) {
                    String str = "招标、采购、拍卖、租赁、询价、竞标、竞价、竞谈、竞拍、竞卖、竞买、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、遴选、标段、明标、明投、出让、招租、预审";
                    ...
                    for (Element element : listElement) {
                        ...
                        if (!CheckProclamationUtil.isValuableByExceptTitleKeyWords(title, rex)) {
                            continue;
                        }
                ...
                if (branch != null) {
                    ...
                    Element contentElement = doc.select("div.content_text").first();
                    if (contentElement != null) {
                        Element titleElement = contentElement.select("div.list_con h1").first();
