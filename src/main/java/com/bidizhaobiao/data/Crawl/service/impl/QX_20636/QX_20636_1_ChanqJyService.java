package com.bidizhaobiao.data.Crawl.service.impl.QX_20636;
 ...
 * 原网站：https://nanao.nongjiao.com/node/98900/landDataMore/1
 * 主页：https://nanao.nongjiao.com
 **/
@Service
public class QX_20636_1_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://nanao.nongjiao.com/node/98900/landDataMore/1";
    public String baseUrl = "https://nanao.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20636-1";
    // 网站名称
    public String sourceName = "南澳县农村产权交易所";
    // 信息源
