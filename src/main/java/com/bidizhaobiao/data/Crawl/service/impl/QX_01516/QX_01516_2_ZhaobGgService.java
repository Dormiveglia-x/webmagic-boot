 ...
 * 程序员：郭建婷
 * 日期：2022-02-15
 * 原网站：http://www.xmta.gov.cn/zc/zdly/gcztb/ztbxx/
 * 主页：http://www.xmta.gov.cn
 **/
@Service("QX_01516_2_ZhaobGgService")
public class QX_01516_2_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://www.xmta.gov.cn/zc/zdly/gcztb/ztbxx/index.htm";
    ...
    // 网站编号
    public String sourceNum = "01516-2";
    // 网站名称
            ...
            if (url.contains("/index")) {
                ...
                if (lists.size() > 0) {
                    for (Element list : lists) {
                        ...
                        String id = "/zc/zdly/gcztb/ztbxx/" + list.select("a").attr("href").replaceAll("\\./", "");
