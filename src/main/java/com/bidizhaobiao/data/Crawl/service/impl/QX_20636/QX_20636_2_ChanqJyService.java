 ...
 * 原网站：https://nanao.nongjiao.com/node/98899/landSearchMore/1
 * 主页：https://nanao.nongjiao.com
 **/
@Service
public class QX_20636_2_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://nanao.nongjiao.com/node/98899/landSearchMore/1";
    public String baseUrl = "https://nanao.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20636-2";
    // 网站名称
