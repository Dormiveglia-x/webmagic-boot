 ...
 * 原网站：首页/供应信息/土地经营权/仅抓取首页标题
 * 主页：http://www.gtxnjs.com
 **/
@Service
public class QX_20645_1_ChanqJyService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "20645-1";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                Element conTag = doc.select("div#productTextList454").first();
