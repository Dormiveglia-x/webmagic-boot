...
@Service("QX_02669_4_ZhongbXxService")
public class QX_02669_4_ZhongbXxService extends SpiderService implements PageProcessor {

    public Spider spider = null;

    public String listUrl = "http://bm.zhangpu-ks.cn/gslist.aspx?key=%E5%BA%9F%E6%A0%87%E5%85%AC%E5%91%8A";
    ...
    // 网站编号
    public String sourceNum = "02669-4";
    // 网站名称
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("key")) {
                ...
                Elements lis = document.select("ul#ul_jsfbgg li:has(a)");
                if (lis.size() > 0) {
                    for (Element li : lis) {
