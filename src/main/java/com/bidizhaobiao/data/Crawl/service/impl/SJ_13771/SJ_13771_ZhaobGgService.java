...
@Service
public class  SJ_13771_ZhaobGgService extends SpiderService implements PageProcessor {

	public Spider spider = null;

	public String listUrl = "http://jalhf.com/zbgg";
	...
	public void process(Page page) {
		...
		try {
			...
			if (url.equals(listUrl)) {
				...
				Element tab = doc.select("div[class=w-article-list clearfix]").first();
				if (tab != null) {
					Elements list = tab.select("div[class=w-al-unit w-icon-hide]:has(a)");
					if (list.size() > 0) {
