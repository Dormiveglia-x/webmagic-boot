...
/**
 * 日期: 2023/2/27
 * 原网站: http://tszx.tsjy.com.cn/xxxw/tzgg.htm
 * 主页: http://tszx.tsjy.com.cn/index.htm
 */
@Service
public class XX7213_ZhaobGgService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://tszx.tsjy.com.cn/xxxw/tzgg.htm";

    public String baseUrl = "http://tszx.tsjy.com.cn";

    // 网站编号
    public String sourceNum = "XX7213";
    // 网站名称
    public String sourceName = "江苏省铜山中学";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            if (url.contains("xxxw")) {
                ...
                Elements liList = listDoc.select("div.pageright li");
                ...
                if(liList.size() > 0){
                    for (Element li : liList) {
                        ...
                        String listDate = StrUtil.trim(li.select("span").first().text());
