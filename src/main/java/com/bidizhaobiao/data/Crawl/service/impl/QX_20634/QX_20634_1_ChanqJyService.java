package com.bidizhaobiao.data.Crawl.service.impl.QX_20634;
 ...
 * 原网站：https://gdchaoyang.nongjiao.com/node/98759/landDataMore/1
 * 主页：https://gdchaoyang.nongjiao.com
 **/
@Service
public class QX_20634_1_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://gdchaoyang.nongjiao.com/node/98759/landDataMore/1";
    public String baseUrl = "https://gdchaoyang.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20634-1";
    // 网站名称
    public String sourceName = "潮阳区农村产权交易所";
    // 信息源
