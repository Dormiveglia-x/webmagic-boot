 ...
 * 原网站：https://huaiji.nongjiao.com/node/100309/landSearchMore/1
 * 主页：https://huaiji.nongjiao.com
 **/
@Service
public class QX_20647_2_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://huaiji.nongjiao.com/node/100309/landSearchMore/1";
    public String baseUrl = "https://huaiji.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20647-2";
    // 网站名称
