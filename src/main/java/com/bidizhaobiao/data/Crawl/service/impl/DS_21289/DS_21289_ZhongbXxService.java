package com.bidizhaobiao.data.Crawl.service.impl.DS_21289;
 ...
 * 原网站：http://gnwhy.jxdckj.vip/whdt_list.aspx?category_id=74
 * 主页：http://gnwhy.jxdckj.vip/
 **/
@Service
public class DS_21289_ZhongbXxService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "http://gnwhy.jxdckj.vip/whdt_list.aspx?category_id=74&whg=0&page=1";
    public String baseUrl = "http://gnwhy.jxdckj.vip";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "21289";
    // 网站名称
    public String sourceName = "赣南文化云";
    // 信息源
    ...
    public void process(Page page) {
        ...
        try {
            ...
            if (url.contains("&page=")) {
                ...
                Elements listElement = doc.select("ul.dzzhdList>li:has(a)");
                if (listElement.size() > 0) {
                    for (Element element : listElement) {
                        ...
                        String date = "";
                        Matcher dateMat = datePat.matcher(a.select("h3").text());
                        if (dateMat.find()) {
                        ...
                        if (title.length() < 2) title = a.select("h2").text().trim();
                ...
                if (branch != null) {
                    ...
                    String content = "";
                    Element contentElement = doc.select("div.xwxqTxt").first();
                    if (contentElement != null) {
                        ...
                        Element titleElement = doc.select("div.xwxqBox>h2").first();
