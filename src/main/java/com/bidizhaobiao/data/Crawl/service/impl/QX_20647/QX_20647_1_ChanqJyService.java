package com.bidizhaobiao.data.Crawl.service.impl.QX_20647;
 ...
 * 原网站：https://huaiji.nongjiao.com/node/100310/landDataMore/1
 * 主页：https://huaiji.nongjiao.com
 **/
@Service
public class QX_20647_1_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://huaiji.nongjiao.com/node/100310/landDataMore/1";
    public String baseUrl = "https://huaiji.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20647-1";
    // 网站名称
    public String sourceName = "怀集县农村产权交易所";
    // 信息源
