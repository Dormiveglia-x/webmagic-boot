 ...
 * 原网站：http://ggzyjy.weihai.cn/rushan/jyxx/003001/003001005/transInfo.html
 * 主页：http://ggzyjy.weihai.cn/
 **/

@Service
public class QX_03870_4_ZhongbXxService extends SpiderService implements PageProcessor {
    ...
    // 网站编号
    public String sourceNum = "03870-4";
    // 网站名称
        ...
        try {
            ...
            if (url.equals("http://ggzyjy.weihai.cn/EpointWebBuilder/rest/getOauthInfoAction/getNoUserAccessToken")) {
                ...
                for (Element element : elementsa) {
                    if (element.attr("onclick").contains("Toggle")) {
                        element.remove();
                    }
                }
    ...
    public Request getListRequest(int pageNo) {
        ...
        try {
            ...
            params.put("params", "{\"siteGuid\":\"caf3f935-94d7-4d37-b361-16db510865c3\",\"categoryNum\":\"003001005\",\"kw\":\"\",\"startDate\":\"\",\"endDate\":\"\",\"pageIndex\":" + pageNo + ",\"pageSize\":12,\"area\":\"\"}");
