 ...
 * 原网站：https://jinpingqu.nongjiao.com/node/98665/landDataMore/1
 * 主页：https://jinpingqu.nongjiao.com
 **/
@Service
public class QX_20632_1_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://jinpingqu.nongjiao.com/node/98665/landDataMore/1";
    public String baseUrl = "https://jinpingqu.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20632-1";
    // 网站名称
        ...
        try {
            ...
            if (url.equals(listUrl)) {
                ...
                if (list.size() >= 12 && serviceContext.isNeedCrawl()) {
                    ...
                    String nextUrl = "https://jinpingqu.nongjiao.com/node/98665/landDataMore/"+nextPage+"?";
