 ...
 * 原网站：https://longhu.nongjiao.com/node/98617/landSearchMore/1
 * 主页：https://longhu.nongjiao.com
 **/
@Service
public class QX_20631_2_ChanqJyService extends SpiderService implements PageProcessor {
    public Spider spider = null;

    public String listUrl = "https://longhu.nongjiao.com/node/98617/landSearchMore/1";
    public String baseUrl = "https://longhu.nongjiao.com";
    public Pattern datePat = Pattern.compile("(\\d{4})(年|/|-|\\.)(\\d{1,2})(月|/|-|\\.)(\\d{1,2})");

    // 网站编号
    public String sourceNum = "20631-2";
    // 网站名称
