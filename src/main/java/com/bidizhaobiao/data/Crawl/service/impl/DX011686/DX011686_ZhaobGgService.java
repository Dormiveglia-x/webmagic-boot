 ...
 * @主页：TODO
 **/
@Service("DX011686_ZhaobGgService")
public class DX011686_ZhaobGgService extends SpiderService implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        try {
            if (url.contains("offset")) {
                ...
                String keys = "设备、招标、采购、询价、询比、竞标、竞价、竞谈、竞拍、竞卖、竞买、竞投、竞租、比选、比价、竞争性、谈判、磋商、投标、邀标、议标、议价、单一来源、遴选、标段、明标、明投、出让、转让、拍卖、招租、预审、发包、开标、答疑、补遗、澄清、挂牌";
